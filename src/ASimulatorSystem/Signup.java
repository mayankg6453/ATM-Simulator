...
public class Signup extends JFrame implements ActionListener {
	...
	Signup(){
		...
		lab.setBounds(180, 0, 100, 100);
		add(lab);

		Font Label=new Font("Raleway",Font.BOLD,20);
		...
		l13=new JLabel("Date:");
		l13.setFont(new Font("Raleway",Font.ITALIC,14));

		l14=new JLabel("Month:");
		l14.setFont(new Font("Raleway",Font.ITALIC,14));

		l15=new JLabel("Year:");
		l15.setFont(new Font("Raleway",Font.ITALIC,14));

		Font Text=new Font("Raleway",Font.BOLD,14);
